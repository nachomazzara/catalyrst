...
export let dgtble_headspace: Wearable[] = [
  ...
  new Wearable(
    ...
    'In your mind\u{FFFD}s eye witness The Flower of Life in this space, floating before you in golden light. Take a moment to absorb the divine wisdom contained in this sacred figure.',
    'upper_body',
    'legendary',
    ['BaseFemale']
  ),
