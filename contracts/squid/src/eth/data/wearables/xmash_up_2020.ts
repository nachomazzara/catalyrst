...
export let xmash_up_2020: Wearable[] = [
  ...
  new Wearable(
    ...
    'FEWO CLOUD SHOES. It\u{2019}s like Walking on Air... | Art by fewocious - 3D Design by vrglit.ch | Guest Artists Collection',
    'feet',
    'mythic',
    ['BaseMale', 'BaseFemale']
  ),
  new Wearable(
    ...
    'The Delbo Comic Cap. Because every great artist needs their hat... | Art by Jos\u{E9} Delbo - 3D Design by vrglit.ch | Guest Artists Collection',
    'hat',
    'mythic',
    ['BaseMale', 'BaseFemale']
  ),
